...
namespace ServiceRest_090_Aqfa_Allowdya_Diamytara
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_090_Aqfa_Allowdya_Diamytara.ContractType".
    [DataContract]
